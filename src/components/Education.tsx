    ...
    const educationData: EducationCard[] = [
        {
            ...
            description: "<span style='display: inline-block; padding: 0.25rem 0.75rem; border-radius: 9999px; font-size: 0.875rem; font-weight: 600; background-color: #d21e69; color: white;'><b>CGPA</b>: 3.6863</span><br><br><b>Institution</b>: Faculty of Information and Communication Technology (FICT), UTAR<br><br>I graduated with a Bachelor of Computer Science (Honours) from <i>Universiti Tunku Abdul Rahman (UTAR)</i> with a CGPA of 3.6863, achieving First-Class Honours and being awarded the UTAR Top Achiever Scholarship (100%) for my degree studies. <br><br>My academic training covered key areas such as <b>Object-Oriented Programming (OOP)</b>, <b>Data Structures</b>, <b>Front-End Web Development</b>, <b>Mobile Application Development</b>, <b>Algorithm Analysis</b>, <b>Database Development</b>, <b>Artificial Intelligence Techniques</b>, and <b>Deep Learning for Data Science</b>, providing me with a strong technical foundation. I was consistently recognized for academic excellence through multiple placements on the President’s List (January 2023, June 2023, June 2025) and the Dean’s List (October 2024). <br><br>Beyond academics, I actively contributed to student organizations as the former Secretary of the <i>UTAR Computer Society</i> and former Vice President of the <i>UTAR Blockchain Club</i>, while participating in various hackathons, workshops, and events to enhance my teamwork, communication, and problem-solving skills.<br><br>In addition, I obtained a professional certificate in 🔗<a href='https://coursera.org/share/7137bd1cb9442cc3de48dde9638db8b6' target='_blank' rel='noopener noreferrer' style='color: blue; text-decoration: underline;'><b>\"Developing Front-End Apps with React\" from <i>International Business Machines Corporation (IBM)</i></b></a> via <i>Coursera</i> through self-directed online learning. Through this program, I explored and applied modern front-end technologies including <i>React</i>, <i>TypeScript</i>, <i>Tailwind CSS</i>, <i>JSX (JavaScript XML)</i>, and <i>Vite</i>, further strengthening my practical web development skills."
        },
        {
            image: cfsUtar,
            ...
            description: "<span style='display: inline-block; padding: 0.25rem 0.75rem; border-radius: 9999px; font-size: 0.875rem; font-weight: 600; background-color: #d21e69; color: white;'><b>CGPA</b>: 3.9600</span><br><br><b>Institution</b>: Centre for Foundation Studies (CFS), UTAR<br><br>I completed my Foundation in Science (P Stream – Physical Science) at <i>Universiti Tunku Abdul Rahman (UTAR)</i> with an outstanding CGPA of 3.9600, supported by the UTAR Top Achiever Scholarship (100%) for my foundation studies. <br><br>My coursework in <b>Programming</b>, <b>Computing Technology</b>, <b>Data Analytics</b>, and <b>Mathematics</b> built a strong analytical and computational foundation that prepared me for advanced studies in computer science. I was consistently recognized for my academic excellence by being placed on the President’s List (January 2022, June 2022, and October 2022), reflecting my strong commitment to learning and high academic performance."
        },
        {
            image: pgs,
