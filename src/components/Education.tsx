...
export default function Education() {
    ...
    const educationData: EducationCard[] = [
        ...
        },
        {
            ...
            description: "<b>CGPA</b>: 3.9600<br><b>Institution</b>: Centre for Foundation Studies (CFS), UTAR<br><br>I completed my Foundation in Science (P Stream – Physical Science) at <i>Universiti Tunku Abdul Rahman (UTAR)</i> with an outstanding CGPA of 3.9600, supported by the UTAR Top Achiever Scholarship (100%) for my foundation studies. <br><br>My coursework in <b>Programming</b>, <b>Computing Technology</b>, <b>Data Analytics</b>, and <b>Mathematics</b> built a strong analytical and computational foundation that prepared me for advanced studies in computer science. I was consistently recognized for my academic excellence by being placed on the President’s List (January 2022, June 2022, and October 2022), reflecting my strong commitment to learning and high academic performance."
        },
        {
            image: pgs,
