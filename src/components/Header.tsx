...
export default function Header() {
    ...
    return (
        <div id="header" className={`relative w-full h-[91vh] min-h-[500px] flex items-end justify-center overflow-hidden transition-colors duration-500 ${isDarkMode ? 'bg-black' : 'bg-white'}`}>
